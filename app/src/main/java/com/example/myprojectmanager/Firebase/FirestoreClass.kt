package com.example.myprojectmanager.Firebase
...
import com.example.myprojectmanager.Activities.CardDetailsActivity
import com.example.myprojectmanager.Activities.Constants
import com.example.myprojectmanager.Activities.CreateBoardActivity
import com.example.myprojectmanager.Activities.MainActivity
import com.example.myprojectmanager.Activities.MembersActivity
import com.example.myprojectmanager.Activities.MyProfileActivity
import com.example.myprojectmanager.Activities.SignInActivity
import com.example.myprojectmanager.Activities.SignUpActivity
...
//            .addOnSuccessListener {
//                Log.d("UserProfileData", "Profile updated successfully")
...
//                    }
//                }
//                Log.e("UserProfileData", "Error updating profile: ${e.message}", e)
//
//                Log.e(
//                    activity.javaClass.simpleName,
//                    "Error while creating a board.",
...
//            }
//    }
    fun updateUserProfileData(activity: Activity, userHashMap: HashMap<String, Any>, newUsername: String) {
        mFireStore.collection(Constants.USERS)
            .document(getCurrentUserID())
            .update(userHashMap)
            .addOnSuccessListener {
                ...
                // Update the username separately
                if (newUsername.isNotEmpty()) {
                    updateUsernameInFirestore(activity, newUsername)
                }
    ...
    private fun updateUsernameInFirestore(activity: Activity, newUsername: String) {
        val usernameMap = HashMap<String, Any>()
        usernameMap[Constants.NAME] = newUsername

        mFireStore.collection(Constants.USERS)
            .document(getCurrentUserID())
            .update(usernameMap)
            .addOnSuccessListener {
                Log.d("UserProfileData", "Username updated successfully")
            }
            .addOnFailureListener { e ->
                when (activity) {
                    is MainActivity -> {
                ...
                Log.e("UserProfileData", "Error updating username: ${e.message}", e)
            }
    }
