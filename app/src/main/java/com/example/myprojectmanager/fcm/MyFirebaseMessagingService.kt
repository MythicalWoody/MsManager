package com.example.myprojectmanager.fcm
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendRegistrationToServer(token: String?) {
        Log.d(TAG, "sendRegistrationToServer: Saving FCM token to SharedPreferences: $token")
    ...
    private fun sendNotification(title: String, message: String) {
        Log.d(TAG, "sendNotification: Creating and showing a notification")
